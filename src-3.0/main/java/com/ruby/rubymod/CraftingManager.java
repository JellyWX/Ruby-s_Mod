...
public class CraftingManager {
	...
	public static void addCraftingRecipes(){
	    ...
	    GameRegistry.addShapedRecipe(new ItemStack(RubyMod.chestplateLinen), "OXO", "OOO", "OOO", 'O', RubyMod.flax);
	    GameRegistry.addShapedRecipe(new ItemStack(RubyMod.helmLinen), "OOO", "OXO", "   ", 'O', RubyMod.flax);
	    GameRegistry.addShapedRecipe(new ItemStack(RubyMod.legsLinen), "OOO", "OXO", "OXO", 'O', RubyMod.flax);
	    GameRegistry.addShapedRecipe(new ItemStack(RubyMod.bootsLinen), "   ", "OXO", "OXO", 'O', RubyMod.flax);
