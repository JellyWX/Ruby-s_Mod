...
public class IronChest extends BlockChest{

	private final Random field_149955_b = new Random();

	public IronChest(int chest){
		super(chest);
	}
	...
	public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityIronChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
	 ...
	 public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
	    {
	        ...
	        TileEntityIronChest tileentitychest = (TileEntityIronChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
	 ...
	 public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
	    {
	        TileEntityIronChest  tileentitychest = (TileEntityIronChest )p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
	 ...
	 public IInventory func_149951_m(World p_149951_1_, int p_149951_2_, int p_149951_3_, int p_149951_4_)
	    {
	        Object object = (TileEntityIronChest )p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
	        ...
	        else
	        {
	            ...
	            {
	                object = new InventoryLargeChest("Large Iron Chest", (TileEntityIronChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
	            }

	            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
	            {
	                object = new InventoryLargeChest("Large Iron Chest", (IInventory)object, (TileEntityIronChest )p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
	            }

	            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
	            {
	                object = new InventoryLargeChest("Large Iron Chest", (TileEntityIronChest )p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
	            }

	            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
	            {
	                object = new InventoryLargeChest("Large Iron Chest", (IInventory)object, (TileEntityIronChest )p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
	            }
	 ...
	 private static boolean func_149953_o(World p_149953_0_, int p_149953_1_, int p_149953_2_, int p_149953_3_)
	  ...
	  @SideOnly(Side.CLIENT)
	    ...
	    {
	        this.blockIcon = p_149651_1_.registerIcon(RubyMod.MODID + ":IronChest");
	    }
