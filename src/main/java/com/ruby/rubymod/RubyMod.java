...
import com.ruby.furnace.block.TileEntityRefinery;
...
import com.ruby.world.oreGen.AlumGen;
import com.ruby.world.oreGen.CopperGen;
import com.ruby.world.oreGen.RubyGen;
import com.ruby.world.oreGen.TinGen;
import com.ruby.world.structGen.Flax;
import com.ruby.world.structGen.FlaxGen;
import com.ruby.world.structGen.FlaxGenerator;
...
public class RubyMod
{
    ...
    public static ToolMaterial Ruby = EnumHelper.addToolMaterial("Ruby", 4, 890, 7.0f, 4.0f, 17);
    ...
    */
    ...
    //public static final Material test = (new Material(MapColor.stoneColor));
    ...
    public static Block RefineryInactive;
    ...
    public void init(FMLPreInitializationEvent event)
    {
       ...
       plantFlax = new com.ruby.blocks.plantFlax(plantFlaxID, Material.vine).setHardness(0.0f).setBlockName("plantFlax").setCreativeTab(RubyMod.rubyTab);

       RefineryInactive = new com.ruby.furnace.block.Refinery(false).setHardness(1.0f).setBlockName("RefineryInactive").setCreativeTab(RubyMod.rubyTab);
       RefineryActive = new com.ruby.furnace.block.Refinery(true).setHardness(1.0f).setBlockName("RefineryActive").setLightLevel(0.625F);
