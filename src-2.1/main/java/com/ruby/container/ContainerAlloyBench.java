...
public class ContainerAlloyBench extends Container {
	...
	public ContainerAlloyBench(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftingMatrixChanged(IInventory iinv){
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != RubyMod.AlloyBench){
			return false;
		}
		else {
