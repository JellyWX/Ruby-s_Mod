...
public class IronChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(RubyMod.MODID + ":textures/blocks/LargeIronChest");
    private static final ResourceLocation field_147504_g = new ResourceLocation(RubyMod.MODID + ":textures/blocks/IronChest");
    ...
    public void renderTileEntityAt(TileEntityIronChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        ...
        else
        {
            ...
            if (block instanceof IronChest && i == 0)
            {
                try
                {
                ((IronChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
