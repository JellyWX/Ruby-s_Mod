...
public class CopperChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation(RubyMod.MODID + ":textures/blocks/LargeCopperChest");
    private static final ResourceLocation field_147504_g = new ResourceLocation(RubyMod.MODID + ":textures/blocks/CopperChest");
    ...
    public void renderTileEntityAt(TileEntityCopperChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof CopperChest && i == 0)
            {
                try
                {
                ((CopperChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityCopperChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}