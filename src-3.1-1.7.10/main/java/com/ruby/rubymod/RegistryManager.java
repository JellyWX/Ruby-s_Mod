...
public class RegistryManager {
	...
	public static void registerBlock(){
	       ...
	       GameRegistry.registerBlock(RubyMod.logCharred, "logCharred");
	...
	public static void registerOther(){
		...
		BiomeDictionary.registerBiomeType(RubyMod.biomeWasteland, BiomeDictionary.Type.DESERT);
	    BiomeManager.addSpawnBiome(RubyMod.biomeWasteland);
	    BiomeManager.warmBiomes.add(new BiomeEntry(RubyMod.biomeWasteland, 30));
	    BiomeManager.addVillageBiome(RubyMod.biomeWasteland, true);
	    
	    BiomeDictionary.registerBiomeType(RubyMod.biomeScrub, BiomeDictionary.Type.FOREST);
	    BiomeManager.addSpawnBiome(RubyMod.biomeScrub);
	    BiomeManager.warmBiomes.add(new BiomeEntry(RubyMod.biomeScrub, 30));
	    
	    /*
	    GameRegistry.registerItem(RubyMod.helmLinen, "helmLinen");
	    GameRegistry.registerItem(RubyMod.chestplateLinen, "chestplateLinen");
	    GameRegistry.registerItem(RubyMod.legsLinen, "legsLinen");
	    GameRegistry.registerItem(RubyMod.bootsLinen, "bootsLinen");
		*/
