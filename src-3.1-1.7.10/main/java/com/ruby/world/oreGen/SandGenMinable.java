...
public class SandGenMinable extends WorldGenerator
{
    ...
    public SandGenMinable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.sand);
    }

    public SandGenMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public SandGenMinable(Block block, int meta, int number, Block target)
    {
